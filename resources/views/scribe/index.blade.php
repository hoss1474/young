                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-register">POST api/register</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-otp-send">
                                <a href="#endpoints-POSTapi-otp-send">POST api/otp/send</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-products-filter">GET api/products/filter</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products-stock-summary">
                                <a href="#endpoints-GETapi-products-stock-summary">GET api/products/stock-summary</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-payment">GET api/payment</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-payment-send">
                                <a href="#endpoints-POSTapi-payment-send">POST api/payment/send</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-payment-callback--order-">
                                <a href="#endpoints-GETapi-payment-callback--order-">GET api/payment/callback/{order}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-otp-send">POST api/otp/send</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-otp-send"
               value="consequatur"
               data-component="body">
    <br>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products-stock-summary">GET api/products/stock-summary</h2>
...
<span id="example-requests-GETapi-products-stock-summary">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/products/stock-summary" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/products/stock-summary"
);
...
<span id="example-responses-GETapi-products-stock-summary">
            <blockquote>
            <p>Example response (500):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-products-stock-summary" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products-stock-summary"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products-stock-summary"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-products-stock-summary" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products-stock-summary">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-products-stock-summary" data-method="GET"
      data-path="api/products/stock-summary"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-products-stock-summary', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products-stock-summary"
                    onclick="tryItOut('GETapi-products-stock-summary');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products-stock-summary"
                    onclick="cancelTryOut('GETapi-products-stock-summary');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products-stock-summary"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/stock-summary</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-products-stock-summary"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-products-stock-summary"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    ...
    \"hover_image\": \"consequatur\",
    \"description\": \"Dolores dolorum amet iste laborum eius est dolor.\",
    \"description_1\": \"consequatur\",
    \"description_2\": \"consequatur\",
    \"description_3\": \"consequatur\",
    \"description_4\": \"consequatur\",
    \"description_5\": \"consequatur\",
    \"images\": [
        \"consequatur\"
    ]
}"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="gender"                data-endpoint="POSTapi-products"
               value="male"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>top</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>top</code></li> <li><code>bottom</code></li> <li><code>accessory</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="discount_price"                data-endpoint="POSTapi-products"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="colors.0.color"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="colors.0.stock"                data-endpoint="POSTapi-products"
               value="45"
               data-component="body">
    <br>
...
<p>Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>hover_image</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="hover_image"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description_1</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_1"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description_2</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_2"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description_3</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_3"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description_4</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_4"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description_5</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_5"                data-endpoint="POSTapi-products"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="gender"                data-endpoint="PUTapi-products--product_id-"
               value="male"
               data-component="body">
    <br>
<p>Example: <code>male</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="discount_price"                data-endpoint="PUTapi-products--product_id-"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="colors.0.color"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>This field is required when <code>colors</code> is present. Example: <code>consequatur</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>stock</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="colors.0.stock"                data-endpoint="PUTapi-products--product_id-"
               value="45"
               data-component="body">
    <br>
<p>This field is required when <code>colors</code> is present. Must be at least 0. Example: <code>45</code></p>
                    </div>
                                    </details>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="main_image"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="hover_image"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_1"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_2"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_3"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_4"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description_5"                data-endpoint="PUTapi-products--product_id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<div class="bash-example">
    ...
    --form "short_description=vmqeopfuudtdsufvyvddq"\
    --form "content=consequatur"\
    --form "author=vmqeopfuudtdsufvyvddq"\
    --form "main_image=@C:\Users\hoss\AppData\Local\Temp\php4D33.tmp" \
    --form "gallery_images[]=@C:\Users\hoss\AppData\Local\Temp\php4D34.tmp" </code></pre></div>
...
body.append('short_description', 'vmqeopfuudtdsufvyvddq');
body.append('content', 'consequatur');
body.append('author', 'vmqeopfuudtdsufvyvddq');
...
<small>file</small>&nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="main_image"                data-endpoint="POSTapi-posts"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Example: <code>C:\Users\hoss\AppData\Local\Temp\php4D33.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="short_description"                data-endpoint="POSTapi-posts"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="gallery_images[0]"                data-endpoint="POSTapi-posts"
               data-component="body">
        <input type="file" style="display: none"
               name="gallery_images[1]"                data-endpoint="POSTapi-posts"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="author"                data-endpoint="POSTapi-posts"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<div class="bash-example">
    ...
    --form "content=consequatur"\
    --form "author=vmqeopfuudtdsufvyvddq"\
    --form "main_image=@C:\Users\hoss\AppData\Local\Temp\php4D55.tmp" \
    --form "gallery_images[]=@C:\Users\hoss\AppData\Local\Temp\php4D56.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="main_image"                data-endpoint="PUTapi-posts--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Example: <code>C:\Users\hoss\AppData\Local\Temp\php4D55.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>short_description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="short_description"                data-endpoint="PUTapi-posts--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 500 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="gallery_images[0]"                data-endpoint="PUTapi-posts--id-"
               data-component="body">
        <input type="file" style="display: none"
               name="gallery_images[1]"                data-endpoint="PUTapi-posts--id-"
               data-component="body">
    <br>
<p>Must be an image.</p>
        </div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="author"                data-endpoint="PUTapi-posts--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<p>The ID of the post. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-payment">GET api/payment</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/payment" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-payment-send">POST api/payment/send</h2>
...
<span id="example-requests-POSTapi-payment-send">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/payment/send" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"amount\": 828,
...
<span id="example-responses-POSTapi-payment-send">
</span>
<span id="execution-results-POSTapi-payment-send" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-payment-send"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-payment-send"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-payment-send" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-payment-send">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-payment-send" data-method="POST"
      data-path="api/payment/send"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-payment-send', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-payment-send"
                    onclick="tryItOut('POSTapi-payment-send');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-payment-send"
                    onclick="cancelTryOut('POSTapi-payment-send');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-payment-send"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/payment/send</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-payment-send"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-payment-send"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="amount"                data-endpoint="POSTapi-payment-send"
               value="828"
               data-component="body">
    <br>
<p>Must be at least 1000. Example: <code>828</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-payment-send"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-payment-send"
               value="fuudtdsufvyvddqamniih"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>fuudtdsufvyvddqamniih</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-payment-callback--order-">GET api/payment/callback/{order}</h2>
...
<span id="example-requests-GETapi-payment-callback--order-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/payment/callback/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/payment/callback/consequatur"
);
...
<span id="example-responses-GETapi-payment-callback--order-">
            <blockquote>
            <p>Example response (500):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-payment-callback--order-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-payment-callback--order-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-payment-callback--order-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-payment-callback--order-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-payment-callback--order-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-payment-callback--order-" data-method="GET"
      data-path="api/payment/callback/{order}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-payment-callback--order-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-payment-callback--order-"
                    onclick="tryItOut('GETapi-payment-callback--order-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-payment-callback--order-"
                    onclick="cancelTryOut('GETapi-payment-callback--order-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-payment-callback--order-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/payment/callback/{order}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-payment-callback--order-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-payment-callback--order-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order"                data-endpoint="GETapi-payment-callback--order-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
